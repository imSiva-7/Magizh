...
export default function History() {
  ...
  function calculateTotal(data) {
    ...
    data.forEach((entry) => {
      stats.totalMilk += parseInt(entry.milk_quantity) || 0; 
  ...
  function downloadCSV() {
    ...
    link.setAttribute(
      "download",
      `production_history_${filterData.fromDate}_to_${filterData.toDate}.csv`
    );
